                        ...
                        <form method="POST">
                            <table class="form-table">
                                <tbody>
                                    ...
                                    <tr valign="top">
                                        <th scope="row"><?php __e( 'Status', 'all-404-pages-redirect-to-homepage' ); ?></th>
                                        <td>
                                    ...
                                    <tr valign="top">
                                        <th scope="row"><?php __e( 'Redirect all 404 pages to:', 'all-404-pages-redirect-to-homepage' ); ?> </th>
                                        <td>

                                            <input type="text" name="redirect_to" id="redirect_to" class="regular-text" value="<?php echo $redirect_to; ?>">
                                            <p class="description"><?php __e( 'Links that redirect for all 404 pages.', 'all-404-pages-redirect-to-homepage' ); ?></p>
                            ...
                            <table class="wp-list-table widefat striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>#</th>
                                        <th><?php __e( 'IP Address', 'all-404-pages-redirect-to-homepage' ); ?></th>
                                        <th><?php __e( 'Date', 'all-404-pages-redirect-to-homepage' ); ?></th>
                                        <th><?php __e( 'URL', 'all-404-pages-redirect-to-homepage' ); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
