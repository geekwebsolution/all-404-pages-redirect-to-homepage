<?php
if (!class_exists('AEPRH_Update_Checker')) {

    class AEPRH_Update_Checker {
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'aeprh_plugin_updates';
